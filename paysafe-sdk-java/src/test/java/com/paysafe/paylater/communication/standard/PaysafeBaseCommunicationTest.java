...
public abstract class PaysafeBaseCommunicationTest extends LocalServerTestBase {
    ...
    protected Answer<Void> htmlResponse(final String resource, final int statusCode) {
        return invocation -> {
            ...
            response.setEntity(new InputStreamEntity(PaysafeConnectionLoggerTest.class.getResourceAsStream(resource)));
