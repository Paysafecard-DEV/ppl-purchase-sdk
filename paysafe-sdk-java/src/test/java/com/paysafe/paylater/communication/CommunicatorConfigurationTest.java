...
public class CommunicatorConfigurationTest {
    ...
    public void testConstructFromProperties() {
        ...
        properties.setProperty("paysafe.paylater.api.endpoint.host", TEST_ENDPOINT_HOST);
    ...
    public void testConstructFromPropertiesWithTimeouts() {
        ...
        Properties properties = new Properties();
        properties.setProperty("paysafe.paylater.api.endpoint.host", TEST_ENDPOINT_HOST);
        properties.setProperty("paysafe.paylater.api.connectTimeout", "7");
        properties.setProperty("paysafe.paylater.api.readTimeout", "5");
    ...
    public void testConstructFromPropertiesWithMaxConnections() {
        ...
        Properties properties = new Properties();
        properties.setProperty("paysafe.paylater.api.endpoint.host", TEST_ENDPOINT_HOST);
        properties.setProperty("paysafe.paylater.api.maxConnections", "100");
    ...
    public void testConstructFromPropertiesWithHostAndScheme() {
        ...
        Properties properties = new Properties();
        properties.setProperty("paysafe.paylater.api.endpoint.host", TEST_ENDPOINT_HOST);
        properties.setProperty("paysafe.paylater.api.endpoint.scheme", "http");
    ...
    public void testConstructFromPropertiesWithHostAndPort() {
        ...
        Properties properties = new Properties();
        properties.setProperty("paysafe.paylater.api.endpoint.host", TEST_ENDPOINT_HOST);
        properties.setProperty("paysafe.paylater.api.endpoint.port", "8443");
    ...
    public void testConstructFromPropertiesWithHostSchemeAndPort() {
        ...
        properties.setProperty("paysafe.paylater.api.endpoint.host", TEST_ENDPOINT_HOST);
        properties.setProperty("paysafe.paylater.api.endpoint.scheme", "http");
        properties.setProperty("paysafe.paylater.api.endpoint.port", "8080");
    ...
    public void testConstructFromPropertiesWithIPv6Host() {
        ...
        Properties properties = new Properties();
        properties.setProperty("paysafe.paylater.api.endpoint.host", "::1");
    ...
    public void testConstructFromPropertiesWithHttpsProtocols() {
        ...
        Properties properties = new Properties();
        properties.setProperty("paysafe.paylater.api.endpoint.host", TEST_ENDPOINT_HOST);
        properties.setProperty("paysafe.paylater.api.https.protocols", "TLSv1, TLSv1.1, TLSv1.2");
