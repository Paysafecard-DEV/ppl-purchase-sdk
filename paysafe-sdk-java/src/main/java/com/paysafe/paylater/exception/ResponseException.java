...
/**
 * Thrown when a response was received from the Paysafe Pay Later platform which indicates an error.
 */
...
public class ResponseException extends RuntimeException {
    ...
    public ResponseException(int statusCode, String body, List<ResponseHeader> headers) {
        super("the Paysafe Pay Later platform returned an error response");
    ...
    /**
     * @return The headers that were returned by the Paysafe Pay Later platform. Never {@code null}.
     */
