...
import com.paysafe.paylater.exception.NotFoundException;
...
/**
 * Standard communicator used to communicate with the Paysafe Pay Later platform web services.
 * <p>
 ...
 * Thread-safe.
 */
public class PaysafeCommunicator implements Communicator {
    ...
    public PaysafeCommunicator(URI apiEndpoint, Connection connection, Marshaller marshaller) {
        if (apiEndpoint == null) {
